...
function layGiaTriInput(){
    ...
    var valid = true;
    valid =
    kiemTraRong(_taiKhoan, "tbMaSV") &
    kiemTraRong(_hoTen, "tbTenSV") &
    kiemTraRong(_email, "tbEmail") &
    kiemTraRong(_diaChi, "tbDiaChi") &
    kiemTraRong(_loaiNguoiDung, "tbLoaiNguoiDung") &
    kiemTraRong(_diemToan, "tbDiemToan") &
    kiemTraRong(_diemLy, "tbDiemLy") &
    kiemTraRong(_diemHoa, "tbDiemHoa") &
    kiemTraRong(_luongNgay, "tbLuongNgay") &
    kiemTraRong(_soNgaylam, "tbSoNgayLam") &
    kiemTraRong(_tenCongTy, "tbTenCongTy") &
    kiemTraRong(_triGiaHoaDon, "tbTriGiaHoaDon") &
    kiemTraRong(_danhGia, "tbDanhGia");
